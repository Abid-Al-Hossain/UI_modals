# UI Foundry Modals Studio

Standalone visual Modals generator built with Next.js, React, and TypeScript.

Standalone Modals component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Modals UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Modals generator
...
The editor is focused on controls that are native to Modals and useful in real product work:
- open state, size, header/body/footer, actions, close button, overlay, and scroll behavior
- surface, backdrop, border, radius, shadow, spacing, and motion-safe entrance
- confirmation, form, detail, destructive, and onboarding modal archetypes
- dialog semantics and focus/dismiss expectations
- React export for modal composition

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Modals.
...
This repo is intended to publish as Abid-Al-Hossain/UI_modals.
